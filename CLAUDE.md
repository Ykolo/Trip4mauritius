...
**143 tests verts** (`npm test`) : concurrence, RULE-001, annulation, cloisonnement opérateur, fuseau, modération, cascade des flags, catégories, cloisonnement des listings, écarts du catalogue admin, recherche par mot-clé, vocabulaire de filtrage, cycle de vie des opérateurs, et publication des deux modes de vente.
